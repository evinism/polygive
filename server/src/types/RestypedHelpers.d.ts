...
export type RTHandler<
  T extends RestypedRoute,
  R extends TypedRequest<T> = TypedRequest<T>
> = (req: R, res: Response) => Promise<T["response"]>;

export type RTAuthedHandler<T extends RTR> = RTHandler<
  T,
  AuthenticatedRequest<T>
>;

export type RTSuperHandler<T extends RTR> = RTHandler<T, SuperRequest<T>>;
