...
export function proveAuthed<T extends RTR>(req: TypedRequest<T>): AuthenticatedRequest<T>{
...
export function requireSuper<T extends RestypedRoute>(handlerFn: RTSuperHandler<T>): RTHandler<T> {
